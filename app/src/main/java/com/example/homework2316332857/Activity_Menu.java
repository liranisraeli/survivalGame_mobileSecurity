package com.example.homework2316332857;
    ...
    private void initViews() {
        this.menu_BTN_start.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                String id = Activity_Menu.this.menu_EDT_id.getText().toString();
                if (id.length()<9 || id.length()>9 ) {
                    Toast.makeText(Activity_Menu.this, "The ID number must be 9 digits", Toast.LENGTH_LONG).show();
                }
                else {
